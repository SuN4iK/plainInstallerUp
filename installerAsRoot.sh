...
echo "plainInstallerUp $RELEASEVERSUN4IK as Root"
...
git clone https://github.com/plainDE/plainPanelUp
...
cd plainAbout
git checkout $RELEASEVERTHMUNIX
qmake
make
